...
import { Button, PayNowSkeleton, Title } from '@travelpulse/ui';
...
const PayNow = dynamic(
	() =>
		import('@travelpulse/ui/components/payment/pay-now-modal').then(
			(m) => m.PayNowModal
		),
	{
		ssr: false,
		loading: () => <PayNowSkeleton />,
	}
);
