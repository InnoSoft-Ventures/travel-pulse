...
import { CountryPackageType, CountryProduct } from '@travelpulse/interfaces';

type HomePageClientProps = {
	popularDestinations: CountryProduct[];
	multipleRegions: CountryProduct[];
};
...
export default function HomePageClient({
	...
	const destinationCardsData: CountryPackageType = hasSearchPackages
		? searchPackages
		: popularDestinations;
			...
			<div id="destination-section">
				<main className={styles.homeMain}>
					...
					<div className={styles.popularDestinationContainer}>
						...
						<DestinationCards
							data={destinationCardsData}
							destinationType={destinationType}
							isLoading={productSearch.status === 'loading'}
						/>
