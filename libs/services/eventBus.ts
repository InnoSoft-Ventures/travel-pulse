...
export interface EventData {
	 ...
	 * @type {string} Queue name, e.g 'user-events', publishing directly to a queue
	 * @type {Envelope} Envelope: publishing to an exchange. `{exchange: 'my-events', routingKey: 'users.visit'}`
	 */
